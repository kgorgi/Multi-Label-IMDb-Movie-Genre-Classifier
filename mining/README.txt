...
Note that a re-trained classifier may have a different model.json file when 
compared to the included one due to the non-deterministic ordering of the keys.
